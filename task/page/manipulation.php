...
$users = [
    ...
    ['name' => 'Ali',   'email' => 'ali@example.com', 'age' => 20, 'phone' => '555-0789', 'city' => 'Amman'],
    ...
    ['name' => 'Serren', 'email' => 'Serren@example.com', 'age' => 25, 'phone' => '555-2021', 'city' => 'Aqaba'],
    ['name' => 'Marwa',  'email' => 'Marwa@example.com', 'age' => 24, 'phone' => '555-2223', 'city' => 'Jarash'],
    ['name' => 'Tariq', 'email' => 'tareq@example.com', 'age' => 31, 'phone' => '555-2425', 'city' => 'Houson'],
    ['name' => 'Salam', 'email' => 'Salam@example.com', 'age' => 26, 'phone' => '555-2627', 'city' => 'Ajloun'],
    ['name' => 'Youssef', 'email' => 'youssef@example.com', 'age' => 23, 'phone' => '555-2829', 'city' => 'Zrqa'],
];
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container mt-5 form-container" id="manipulation">
        ...
        <form method="post" class="mb-4">
            ...
            <button type="submit" class="btn btn-secondary" name="show_users">Filter Users</button>
        </form>
